  ...
  return (
        <section className="w-full overflow-x-clip py-12 lg:py-15 bg-white font-dm-sans relative">
            <div className="max-w-360 mx-auto px-3 relative">
                ...
                <p className="text-base 2xl:text-lg max-w-80 sm:max-w-none text-center text-neutral-700 font-normal tracking-tight">Choose from our comfortable fleet for a smooth, hassle-free airport transfer</p>
                </div>
