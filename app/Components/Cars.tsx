...
const Cars = () => {
  return (
        <section className="w-full bg-white overflow-x-clip py-18 font-dm-sans relative">
            <div className="max-w-360 mx-auto px-3 relative">
                ...
                <h2 className="text-[32px] sm:text-[39px] 2xl:text-5xl font-medium max-w-65 sm:max-w-none tracking-tighter text-center text-neutral-900">
                    Travel Smart, Arrive Relaxed
                </h2>
                <p className="text-base 2xl:text-lg text-neutral-700 font-normal tracking-tight">Choose from our comfortable fleet for a smooth, hassle-free airport transfer</p>
                </div>
