...
const Process = () => {
    return (
        <section className="w-full bg-white overflow-clip py-15 font-dm-sans relative">
            ...
            <div className='w-full max-w-360 mx-auto flex flex-col lg:flex-row justify-center items-center gap-7 px-3 mb-12'>
                <div className="w-full relative  max-w-120 h-125 order-2 lg:-order-2 rounded-3xl overflow-clip">
                    ...
                    <span className='absolute bottom-5 text-2xl tracking-tighter z-20 text-white w-full text-center'>Book in Seconds, Ride in Comfort</span>
