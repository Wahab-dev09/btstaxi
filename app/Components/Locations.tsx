  ...
  return (
        <section id='locations' className="w-full bg-white overflow-x-clip py-12 md:pb-20 font-dm-sans relative">
            <div className="max-w-360 mx-auto px-3 relative">
                ...
                <h2 className="text-[32px] sm:text-[39px] 2xl:text-5xl font-medium max-w-70 sm:max-w-none tracking-tighter text-center text-neutral-900">
                    We Serve Locations All Across UK
                </h2>
