...
const Locations = () => {
  return (
        <section className="w-full bg-white overflow-x-clip py-12 md:pb-20 font-dm-sans relative">
            <div className="max-w-360 mx-auto px-3 relative">
                ...
                <p className="text-base 2xl:text-lg text-neutral-700 text-center font-normal tracking-tight">Reliable transfers from the region's busiest terminals, always on time</p>
                </div>
